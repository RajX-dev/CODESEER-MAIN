...
## Era 1: The Foundations (Days 0–5)
...
## Era 2: Code Extraction & Multi-Language Exploration (Days 6–24)
...
## Era 3: Performance & Scale (Phase 2)
...
* **The Story**:
  ...
  The roadmap table now shows all phases as [Complete] with no "[X] Replaced" lines. It finally feels like a product page, not a work-in-progress doc.
