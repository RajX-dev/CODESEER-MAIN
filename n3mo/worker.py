...
def main():
    ...
    try:
        ...
        # Check SaaS limits
        max_loc = -1  # No limit by default (self-hosted / open source)
        plan_name = "Unlimited"
            ...
            try:
                ...
                if sub.get("status") == "active":
                    ...
                    if sub.get("plan_type") == "enterprise":
                        ...
                        max_loc = 70000
                    elif sub.get("plan_type") == "starter":
                        max_loc = 30000
                    else:
                        max_loc = 15000
            except ImportError:
                logger.info("saas_db not available, running in open-source mode with no LOC limits.")
